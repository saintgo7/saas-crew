...
export function HeroSection() {
  ...
  return (
    <section className="bg-white dark:bg-gray-950 pt-32 pb-16 px-6">
      <motion.div
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-2xl overflow-hidden">
            ...
            <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
              ...
              <div className="flex-1 mx-4">
                <div className="h-6 rounded-md bg-gray-200 dark:bg-gray-700 max-w-md mx-auto" />
              </div>
            </div>
            {/* Kanban board mockup */}
            <div className="p-6 bg-gray-50 dark:bg-gray-800/50 min-h-[320px] md:min-h-[400px]">
              <div className="flex items-center gap-3 mb-6">
                <div className="h-5 w-24 rounded bg-gray-200 dark:bg-gray-700" />
                <div className="text-xs text-gray-400">{'>'}</div>
                <div className="h-5 w-32 rounded bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-xs flex items-center px-2 font-medium">
                  {t('nav.projects')}
                </div>
              </div>
                ...
                {['To Do', 'In Progress', 'Review', 'Done'].map((col, ci) => (
                  <div key={col} className="space-y-3">
                    ...
                    {Array.from({ length: Math.max(1, 3 - ci) }).map((_, i) => (
                      <div
                        key={i}
                        className="p-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 space-y-2"
                      >
                        ...
                        <div className="flex gap-1.5 pt-1">
                          <div className={`h-4 w-12 rounded-full text-[10px] flex items-center justify-center font-medium ${
                            ci === 0 ? 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400' :
                            ci === 1 ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' :
                            ci === 2 ? 'bg-yellow-50 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400' :
