...
function FeatureMockup({ icons }: { icons: readonly (typeof FolderGit2)[] }) {
  return (
    <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-lg overflow-hidden">
      ...
      <div className="p-5 space-y-4 bg-gray-50 dark:bg-gray-800/50">
        <div className="flex items-center justify-between">
          <div className="h-4 w-28 rounded bg-gray-200 dark:bg-gray-700" />
          <div className="flex gap-2">
            {icons.map((Icon, i) => (
              <div key={i} className="w-8 h-8 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[0, 1, 2, 3].map((i) => (
            <div key={i} className="p-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 space-y-2">
        ...
        <div className="flex gap-3">
          <div className="flex-1 p-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            <div className="h-2 w-8 rounded bg-gray-200 dark:bg-gray-600 mb-1.5" />
            <div className="h-4 w-12 rounded bg-blue-50 dark:bg-blue-900/30" />
          </div>
          <div className="flex-1 p-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            <div className="h-2 w-8 rounded bg-gray-200 dark:bg-gray-600 mb-1.5" />
            <div className="h-4 w-12 rounded bg-green-50 dark:bg-green-900/30" />
          </div>
        </div>
      </div>
    </div>
