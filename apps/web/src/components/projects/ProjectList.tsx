...
const DEMO_PROJECTS: Project[] = [
  {
    ...
    name: 'Crew Platform',
    slug: 'crew-platform',
    description: 'WKU Software Crew의 메인 플랫폼. Next.js + NestJS + PostgreSQL 기반의 풀스택 웹 애플리케이션으로, 프로젝트 관리, 코스 학습, 커뮤니티 기능을 제공합니다.',
    visibility: 'PUBLIC',
    status: 'in_progress',
  ...
  },
  {
    ...
    name: 'WKU Campus Map',
    slug: 'wku-campus-map',
    description: '원광대학교 캠퍼스 인터랙티브 지도 앱. React Native로 개발한 모바일 앱으로, 건물 검색, 경로 안내, 시설 정보를 제공합니다.',
    visibility: 'PUBLIC',
    status: 'in_progress',
  ...
  },
  {
    ...
    description: '원광대학교 스터디룸 예약 시스템. 실시간 예약 현황 확인, QR 체크인, 사용 통계 대시보드를 제공합니다.',
    visibility: 'PUBLIC',
    status: 'planning',
