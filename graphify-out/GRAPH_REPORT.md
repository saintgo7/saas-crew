...
2. `AI & Machine Learning` - 139 edges
3. `cn()` - 98 edges
4. `PrismaService` - 60 edges
5. `Backend Development` - 59 edges
6. `Backend Development` - 59 edges
7. `useLanguage()` - 58 edges
8. `Database & Data` - 52 edges
9. `Database & Data` - 52 edges
...
Cohesion: 0.14
Nodes (14): Downvote (비추천), Step 1: 게시물 찾기, Step 2: 투표 버튼 클릭, Step 3: 결과 확인, Upvote (추천), 중복 투표 방지, 투표 권한, 투표 방법 (+6 more)

### Community 199 - "Community 199"
Cohesion: 0.14
Nodes (14): 5.1 Macro Trends, 5.2 Industry-Specific Trends, 5.3 Technology Trends, 5. Market Trends & Dynamics, Cloud Computing, EdTech Trends, Higher Education Trends, Low-Code/No-Code (+6 more)

### Community 200 - "Community 200"
Cohesion: 0.14
Nodes (13): 1.1 Competitive Landscape Overview, 1.2 Competitive Strategy, 1. Executive Summary, 4.1 Feature Comparison Matrix, 4.2 Pricing Comparison, 4.3 Target Market Comparison, 4. Competitive Matrix, Appendix A: Detailed Competitor Financial Analysis (+5 more)

### Community 201 - "Community 201"
Cohesion: 0.14
Nodes (14): FR-1.1.1 이메일 회원가입 [P0], FR-1.1.2 소셜 로그인 [P0], FR-1.1.3 이메일 인증 [P0], FR-1.1.4 로그인/로그아웃 [P0], FR-1.1.5 비밀번호 재설정 [P0], FR-1.1 회원가입 및 로그인, FR-1.2.1 프로필 보기/수정 [P0], FR-1.2.2 레벨 및 스킬 [P1] (+6 more)
...
Cohesion: 0.14
Nodes (14): devDependencies, autoprefixer, eslint, eslint-config-next, @next/bundle-analyzer, @playwright/test, postcss, tailwindcss (+6 more)
...
Cohesion: 0.21
Nodes (10): generateMetadata(), getProject(), PageProps, ProjectDetailPage(), Project, ProjectDetailContent(), ProjectDetailContentProps, ProjectTabs() (+2 more)

### Community 208 - "Community 208"
Cohesion: 0.15
Nodes (13): 2.3 API 설계 및 엔드포인트 정의, API 문서 (Swagger), GET /api/courses, GET /api/courses/:id/progress, GET /api/projects, GET /api/projects/:id, GET /api/users/:id, PATCH /api/users/:id (+5 more)

### Community 210 - "Community 210"
Cohesion: 0.15
Nodes (12): Bundle Size Reduction, Caching Strategy, Changes Made, Database Indexes Added, Database Optimization, Dev Log #006: Performance Optimization, Frontend Optimization, Monitoring (+4 more)

### Community 211 - "Community 211"
Cohesion: 0.15
Nodes (12): Changes Made, CI/CD Security, Dev Log #007: Security Hardening, OWASP Top 10 Coverage, Rate Limiting Configuration, Related, Security Features, Security Headers (Helmet) (+4 more)

### Community 212 - "Community 212"
Cohesion: 0.15
Nodes (12): Changes Made, Coverage Targets, Dev Log #008: Comprehensive Test Coverage, E2E Tests, Integration Tests Added, Related, Summary, Technical Details (+4 more)

### Community 213 - "Community 213"
Cohesion: 0.15
Nodes (12): 1. SSH 배포 키, 2. GitHub Secrets, 3. Branch Protection, 4. 서버 설정, 5. Cloudflare Staging Routes, 6. 테스트, Git Flow 설정 진행 상황, 다음 단계 (+4 more)

### Community 214 - "Community 214"
Cohesion: 0.15
Nodes (13): 1. 검색 먼저 하기, 1. 친절하게 설명하기, 2. 구체적으로 질문하기, 2. 정확한 정보 제공, 3. 감사 표현하기, 3. 코드 예제 제공, XP 최대화 전략, 꾸준한 활동 (+5 more)

### Community 215 - "Community 215"
Cohesion: 0.15
Nodes (12): CI/CD 파이프라인, E2E Testing Architecture, 리포팅 시스템, 모범 사례 요약, 성능 테스트 아키텍처, 시스템 아키텍처, 인증 모킹 아키텍처, 접근성 테스트 아키텍처 (+4 more)

### Community 216 - "Community 216"
Cohesion: 0.15
Nodes (12): 1. Revenue Projections (3 Years), 2. Cost Structure (3 Years), 3. Profitability Analysis, 4. Unit Economics, 5. Cash Flow Projections, 6.1 Pre-Seed Round (Q1 2026), 6.2 Seed Round (Q4 2026), 6.3 Series A (Year 2) (+4 more)

### Community 217 - "Community 217"
Cohesion: 0.15
Nodes (13): 1.1 글로벌 시장 규모, 1.2 국내 시장 규모, 1.3 타겟 시장 규모 (TAM-SAM-SOM), 1. 시장 개요, SAM (Serviceable Available Market), SOM (Serviceable Obtainable Market), TAM (Total Addressable Market), 개발자 도구 시장 (+5 more)

### Community 218 - "Community 218"
Cohesion: 0.15
Nodes (12): 1.1 경쟁 매트릭스, 1.2 경쟁 분류, 1. 경쟁 구도 개요, 2. 직접 경쟁사 상세 분석, 8.1 모니터링 지표, 8.2 정보 수집 채널, 8.3 대응 프로세스, 8. 경쟁 모니터링 계획 (+4 more)

### Community 219 - "Community 219"
Cohesion: 0.15
Nodes (13): FR-3.1.1 웹 기반 IDE [P0], FR-3.1.2 파일 시스템 [P0], FR-3.1.3 터미널 [P0], FR-3.1.4 실행 및 디버깅 [P1], FR-3.1 코드 에디터, FR-3.2.1 프로젝트 템플릿 [P0], FR-3.2.2 패키지 관리 [P0], FR-3.2.3 환경 변수 [P1] (+5 more)

### Community 220 - "Community 220"
Cohesion: 0.15
Nodes (13): 2.1 컬러 팔레트, 2.2 타이포그래피, 2.3 Spacing (간격), 2.4 Border Radius, 2.5 Shadows, 2. 디자인 시스템, Font Family, Font Scale (+5 more)

### Community 221 - "Community 221"
Cohesion: 0.15
Nodes (13): 5.1 애니메이션 원칙, 5.2 Micro-interactions, 5.3 Page Transitions, 5. 애니메이션 & 인터랙션, Button Click, Card Hover, Duration (지속 시간), Easing (가감속) (+5 more)

### Community 222 - "Community 222"
Cohesion: 0.15
Nodes (12): 1.1 프로젝트 타임라인, 1.2 마일스톤, 1. 전체 일정 개요, 4.1 멘토링 시스템 (7월), 4.2 창업 지원 (8월), 4.3 스터디 그룹 (9월), 4. Phase 3: 고급 기능 (7-9월), 5.1 성능 최적화 (10월) (+4 more)

### Community 223 - "Community 223"
Cohesion: 0.15
Nodes (13): 3.1 Product (제품), 3.2 Price (가격), 3.3 Place (유통), 3.4 Promotion (프로모션), 3. 마케팅 믹스 (4P), Freemium 모델, 오프라인 마케팅, 오프라인 채널 (+5 more)

### Community 224 - "Community 224"
Cohesion: 0.15
Nodes (13): 3.1 주요 조항, 제10조 (손해배상), 제11조 (면책 조항), 제12조 (준거법 및 관할), 제1조 (목적), 제2조 (정의), 제3조 (약관의 효력 및 변경), 제4조 (회원 가입) (+5 more)

### Community 225 - "Community 225"
Cohesion: 0.24
Nodes (12): format_date(), generate_html(), generate_timeline_item_html(), get_date_only(), get_type_info(), get_weekday(), group_logs_by_date(), main() (+4 more)

### Community 226 - "Community 226"
Cohesion: 0.17
Nodes (11): CrewSpace - Mermaid Diagrams, fig-01-01: System Architecture Overview, fig-02-01: Database ERD (Entity Relationship Diagram), fig-02-02: API Endpoint Structure, fig-03-01: Frontend Routing Structure, fig-04-01: GitHub OAuth Flow, fig-05-01: CI/CD Pipeline, fig-06-01: Component Hierarchy (Frontend) (+3 more)

### Community 227 - "Community 227"
Cohesion: 0.17
Nodes (12): Step 1: 질문 찾기, Step 2: 질문 읽기, Step 3: 답변 작성, Step 4: 답변 게시, 검색, 답변 달기, 답변 삭제, 답변 수정 (+4 more)

### Community 228 - "Community 228"
Cohesion: 0.17
Nodes (12): Step 1: 커뮤니티 페이지 이동, Step 2: 새 질문 작성, Step 3: 제목 입력, Step 4: 본문 작성, Step 5: 태그 추가, Step 6: 미리보기 및 게시, 문제 설명, 시도한 방법 (+4 more)

### Community 229 - "Community 229"
Cohesion: 0.17
Nodes (12): 1. 꾸준히 학습하기, 2. 실습 위주로 학습, 3. 메모하기, 4. 복습하기, 기한 설정, 스터디 그룹, 자신의 페이스 유지, 질문하기 (+4 more)

### Community 230 - "Community 230"
Cohesion: 0.17
Nodes (12): Step 1: 코스 페이지 접속, Step 2: 코스 필터링, Step 3: 코스 정렬, Step 4: 코스 카드 확인, Step 5: 코스 상세 확인, 레벨별 필터, 수강 정보, 카테고리별 필터 (+4 more)

### Community 231 - "Community 231"
Cohesion: 0.17
Nodes (12): ADMIN (관리자), MEMBER (멤버), OWNER (소유자), VIEWER (뷰어), 권한 있는 사용자, 변경 절차, 제거 절차, 주의사항 (+4 more)

### Community 232 - "Community 232"
Cohesion: 0.17
Nodes (12): Step 1: 프로젝트 페이지 이동, Step 2: 기본 정보 입력, Step 3: 기술 스택 선택, Step 4: GitHub 저장소 연동 (선택, 권장), Step 5: 배포 URL 입력 (선택), Step 6: 커버 이미지 업로드 (선택), Step 7: 가시성 설정, Step 8: 저장 및 확인 (+4 more)

### Community 233 - "Community 233"
Cohesion: 0.17
Nodes (12): 3.1 Buttons, 3.2 Form Inputs, 3.3 Cards, 3.4 Navigation, 3.5 Modals, 3. Components, Button Variants, Input States (+4 more)

### Community 234 - "Community 234"
Cohesion: 0.17
Nodes (12): 1. 대학 특화 플랫폼 부재, 2. 협업 학습 경험 부족, 3. 창업 지원 생태계 미비, 4. 단계별 성장 경로 불명확, 5.1 Unmet Needs (충족되지 않은 니즈), 5.2 시장 진입 전략, 5.3 시장 진입 장벽, 5. 시장 기회 (+4 more)

### Community 235 - "Community 235"
Cohesion: 0.17
Nodes (12): 3.1 고객 세그먼트, 3.2 고객 페르소나, 3.3 고객 여정 맵 (Customer Journey Map), 3. 고객 분석, Junior Class, Junior Class (초급), Master Class (고급), Senior Class (중급) (+4 more)

### Community 236 - "Community 236"
Cohesion: 0.17
Nodes (12): 고충 및 불만, 기본 정보, 기술 프로필, 니즈 및 기대, 목표 및 동기, 사용 행동, 성격 및 가치관, 성공 시나리오 (+4 more)
...
Cohesion: 0.17
Nodes (12): FR-2.1.1 코스 목록 [P0], FR-2.1.2 코스 상세 [P0], FR-2.1.3 학습 진행 [P0], FR-2.1.4 동영상 플레이어 [P0], FR-2.1.5 과제 및 실습 [P0], FR-2.1.6 수료증 [P1], FR-2.1 커리큘럼, FR-2.2.1 노트 기능 [P1] (+4 more)

### Community 241 - "Community 241"
Cohesion: 0.17
Nodes (12): FR-4.1.1 프로젝트 생성 [P0], FR-4.1.2 프로젝트 목록 [P0], FR-4.1.3 프로젝트 설정 [P1], FR-4.1 프로젝트 생성 및 관리, FR-4.2.1 팀원 초대 [P0], FR-4.2.2 실시간 협업 [P1], FR-4.2.3 버전 관리 (Git) [P0], FR-4.2 팀 협업 (+4 more)

### Community 242 - "Community 242"
Cohesion: 0.17
Nodes (12): 2.1 기술 스택, 2.2 폴더 구조, 2.3.1 Monaco Editor 통합, 2.3.2 실시간 협업 (Y.js), 2.3 주요 기능 구현, 2. 프론트엔드 아키텍처, Code Editor, Core Framework (+4 more)

### Community 243 - "Community 243"
Cohesion: 0.17
Nodes (12): 3.1 Week 11: 베타 테스트 (4/2 - 4/15), 3.2 Week 12-13: 정식 런칭 준비 (4/16 - 4/29), 3.3 Week 14: 정식 런칭 (4/30), 3.4 Week 15-20: 핵심 기능 추가 (5/1 - 6/15), 3.5 Week 21-24: Senior/Master 클래스 준비 (6/16 - 7/15), 3. Phase 2: 정식 런칭 (4-6월), 개선, 레벨 시스템 (Week 15-16) (+4 more)
...
Cohesion: 0.18
Nodes (10): Backend (NestJS), Changes Made, Database Schema, Dev Log #001: Project Initialization & Phase 1-5, Frontend (Next.js), Project Structure, Related, Summary (+2 more)

### Community 248 - "Community 248"
Cohesion: 0.18
Nodes (10): Backend (10 courses), Changes Made, Courses Added (30 total), Database (10 courses), Database Migration, Dev Log #005: 30 Coding Courses Curriculum, Frontend (10 courses), Related (+2 more)

### Community 249 - "Community 249"
Cohesion: 0.18
Nodes (11): 1. 무례한 행동, 1. 존중하기, 2. 구체적으로 작성, 2. 숙제 대신 해달라는 요청, 3. 감사 표현, 3. 중복 질문, 4. 스팸, 4. 피드백 제공 (+3 more)

### Community 250 - "Community 250"
Cohesion: 0.18
Nodes (11): 1. 로컬 환경에서 작업, 2. GitHub에 업로드, Step 1: 제출 양식 열기, Step 2: 제출 정보 입력, Step 3: 제출, 과제 작업, 과제 재제출, 과제 제출 (+3 more)

### Community 251 - "Community 251"
Cohesion: 0.18
Nodes (10): GitHub 연동 최대 활용, 다음 단계, 도움이 필요하신가요?, 목차, 문의하기, 좋아요 늘리기, 추가 가이드, 포트폴리오로 활용하기 (+2 more)

### Community 252 - "Community 252"
Cohesion: 0.18
Nodes (11): 5.1 Three-Tier Class System, 5.2 Platform Features, 5. Product Structure, **Cloud IDE**:, **Community & Mentoring**:, **Deployment System**:, **Junior Class** (Beginner Level), **Learning Management System (LMS)**: (+3 more)

### Community 253 - "Community 253"
Cohesion: 0.18
Nodes (11): 2.10 Quote, 2.1 Demographics, 2.2 Background, 2.3 Goals, 2.4 Pain Points, 2.5 Motivations, 2.6 Behaviors, 2.7 User Journey (+3 more)

### Community 254 - "Community 254"
Cohesion: 0.18
Nodes (11): 3.10 Quote, 3.1 Demographics, 3.2 Background, 3.3 Goals, 3.4 Pain Points, 3.5 Motivations, 3.6 Behaviors, 3.7 User Journey (+3 more)

### Community 255 - "Community 255"
Cohesion: 0.18
Nodes (11): 4.10 Quote, 4.1 Demographics, 4.2 Background, 4.3 Goals, 4.4 Pain Points, 4.5 Motivations, 4.6 Behaviors, 4.7 User Journey (+3 more)

### Community 256 - "Community 256"
Cohesion: 0.18
Nodes (10): 10.1 핵심 지표 (North Star Metric), 10.2 보조 지표, 10.3 대시보드 설계, 10. 성공 지표 및 모니터링, 1.2 비즈니스 모델 유형, 1. 비즈니스 모델 개요, WKU 소프트웨어 Crew Project - 비즈니스 모델, 사용자 지표 (+2 more)

### Community 257 - "Community 257"
Cohesion: 0.18
Nodes (11): 5.1 가격 책정 근거, 5.2 할인 정책, 5.3 가격 실험 계획, 5. 가격 전략, A/B 테스트, Premium Tier (₩9,900), Pro Tier (₩29,900), University License (₩30,000,000/년) (+3 more)

### Community 258 - "Community 258"
Cohesion: 0.18
Nodes (11): 1. 클라우드 네이티브, 1. 프로젝트 기반 학습 (PBL), 2.2 기술 트렌드, 2.3 교육 트렌드, 2. 마이크로 크레딧, 2. 시장 트렌드, 2. 실시간 협업, 3. 게이미피케이션 (+3 more)

### Community 259 - "Community 259"
Cohesion: 0.18
Nodes (11): 1. 대학 특화 생태계, 2. 올인원 통합 플랫폼, 3. 단계별 성장 시스템, 4. 창업 생태계, 5.1 핵심 차별화 요소, 5.2 경쟁 우위 매트릭스, 5.3 진입 장벽 구축, 5. 경쟁 우위 분석 (+3 more)

### Community 260 - "Community 260"
Cohesion: 0.18
Nodes (11): 2.1 엘리스 (Elice), WKU CREW와 비교, 강점 (Strengths), 경쟁 전략, 기회 (Opportunities), 비즈니스 모델, 시장 포지셔닝, 약점 (Weaknesses) (+3 more)

### Community 261 - "Community 261"
Cohesion: 0.18
Nodes (11): 2.2 프로그래머스 (Programmers), WKU CREW와 비교, 강점 (Strengths), 경쟁 전략, 기회 (Opportunities), 비즈니스 모델, 시장 포지셔닝, 약점 (Weaknesses) (+3 more)

### Community 262 - "Community 262"
Cohesion: 0.18
Nodes (11): 2.3 인프런 (Inflearn), WKU CREW와 비교, 강점 (Strengths), 경쟁 전략, 기회 (Opportunities), 비즈니스 모델, 시장 포지셔닝, 약점 (Weaknesses) (+3 more)

### Community 263 - "Community 263"
Cohesion: 0.18
Nodes (10): 1.1 페르소나 세그먼트 구조, 1. 페르소나 개요, 2. Primary Personas (학생), 3. Secondary Personas, 4. 사용자 여정 비교, 5.1 제품 우선순위, 5.2 마케팅 메시지, 5.3 기능 개발 우선순위 (+2 more)

### Community 264 - "Community 264"
Cohesion: 0.18
Nodes (11): 고충 및 불만, 기본 정보, 기술 프로필, 니즈 및 기대, 목표 및 동기, 사용 행동, 성격 및 가치관, 성공 시나리오 (+3 more)

### Community 265 - "Community 265"
Cohesion: 0.18
Nodes (11): 7.1 인프라 모니터링, 7.2 정기 점검, 7.3 백업 및 복구, 7. 서버 운영, 대시보드, 모니터링 지표, 백업 정책, 알림 (Alerting) (+3 more)

### Community 266 - "Community 266"
Cohesion: 0.18
Nodes (10): 10.1 월간 추적 지표, 10.2 분기별 검토, 10. 재무 KPI, 13.1 회계 기준, 13.2 외부 감사, 13. 감사 및 회계, 4.1 1년차 손익 계산서, 4.2 3년 손익 전망 (+2 more)

### Community 267 - "Community 267"
Cohesion: 0.18
Nodes (10): Domain Expertise, Milestones, Overview, Phase 7: Testing & Quality, Phase 8: Documentation & Deployment, Phase Details, Phases, Progress (+2 more)

### Community 268 - "Community 268"
Cohesion: 0.18
Nodes (10): devDependencies, typescript, main, name, private, scripts, lint, type-check (+2 more)

### Community 269 - "Community 269"
Cohesion: 0.20
Nodes (9): Commands Reference, Prerequisites Checklist, Quick Start - WKU Software Crew Deployment, Step 1: Cloudflare Tunnel (2분), Step 2: Server Setup (2분), Step 3: Configuration (1분), Step 4: Deploy, Step 5: Frontend (Cloudflare Pages) (+1 more)

### Community 270 - "Community 270"
Cohesion: 0.20
Nodes (9): API Endpoints, Changes Made, Dev Log #002: Community Features (Phase 6), Features Added, Frontend Pages, Related, Summary, Technical Details (+1 more)

### Community 271 - "Community 271"
Cohesion: 0.20
Nodes (9): Changes Made, Dev Log #003: Internationalization (i18n), Features Added, Files Modified, Related, Summary, Technical Details, Test Results (+1 more)

### Community 272 - "Community 272"
Cohesion: 0.20
Nodes (9): API Endpoints, Changes Made, Dev Log #004: GitHub OAuth Authentication, Features Added, Frontend Components, Related, Summary, Technical Details (+1 more)

### Community 273 - "Community 273"
Cohesion: 0.20
Nodes (9): Cloudflare Staging Routes 설정 가이드, Step 1: Cloudflare 대시보드 접속, Step 2: Tunnel 설정 페이지 이동, Step 3: 첫 번째 라우트 추가 (Frontend), Step 4: 두 번째 라우트 추가 (API), 개요, 설정 단계, 설정 확인 (+1 more)

### Community 274 - "Community 274"
Cohesion: 0.20
Nodes (9): 🛠 Agent & Skill 매핑, Hook 활용, Parallel Execution, Ralph Loop 최대 활용, WKU Software Crew - 기능 구현 계획, ✅ 완료, 💡 팁, 📋 프로젝트 현황 (+1 more)

### Community 275 - "Community 275"
Cohesion: 0.20
Nodes (10): 3. 모든 컨트롤러 문서화 (9개), AuthController, ChaptersController, CommentsController, CoursesController, EnrollmentsController, PostsController, ProjectsController (+2 more)

### Community 276 - "Community 276"
Cohesion: 0.20
Nodes (10): 1. 존중과 배려, 2. 구체적인 질문, 3. 감사 표현, XP 획득, 지식 공유, 커뮤니티 규칙, 커뮤니티 소개, 커뮤니티란? (+2 more)

### Community 277 - "Community 277"
Cohesion: 0.20
Nodes (10): Step 1: 댓글 입력란 찾기, Step 2: 댓글 입력, Step 3: 게시, 답변, 댓글, 댓글 기능, 댓글 답글 (대댓글), 댓글 수정 및 삭제 (+2 more)

### Community 278 - "Community 278"
Cohesion: 0.20
Nodes (10): JUNIOR (초급), MASTER (고급), SENIOR (중급), XP 획득, 스킬 증명, 체계적 성장, 코스 레벨 시스템, 코스 시스템 소개 (+2 more)

### Community 279 - "Community 279"
Cohesion: 0.20
Nodes (10): 2.1 Global EdTech Market, 2.2 Korean EdTech Market, 2.3 Coding Education Market, 2. Total Addressable Market (TAM), Global Coding Bootcamp Market, Korean Coding Education Market, Korean Higher Education Market, Market Segmentation (+2 more)

### Community 280 - "Community 280"
Cohesion: 0.20
Nodes (10): 6.1 Demographic Segmentation, 6.2 Psychographic Segmentation, 6.3 Behavioral Segmentation, 6. Market Segmentation Analysis, By Age Group, By Gender, By Learning Stage, By Major (+2 more)

### Community 281 - "Community 281"
Cohesion: 0.20
Nodes (10): 7.1 Direct Competitors, 7.2 Indirect Competitors, 7.3 Competitive Matrix, 7.4 Competitive Advantages, 7. Competitive Landscape, Competitor 1: Elice, Competitor 2: Inflearn, Competitor 3: Programmers (+2 more)

### Community 282 - "Community 282"
Cohesion: 0.20
Nodes (9): 10. FR-8: Admin & Analytics, 14. Requirements Traceability Matrix, 2.1 Feature Priorities, 2.2 Requirements Summary, 2. Requirements Overview, FR-10.1: Admin Dashboard [P0], FR-8.2: Analytics Dashboard [P1], FR-8.3: User Feedback System [P1] (+1 more)

### Community 283 - "Community 283"
Cohesion: 0.20
Nodes (10): 4. FR-2: Learning Management System (LMS), FR-2.1: Course Catalog [P0], FR-2.2: Course Details Page [P0], FR-2.3: Course Enrollment [P0], FR-2.4: Video Player [P0], FR-2.5: Interactive Quizzes [P0], FR-2.6: Coding Exercises [P0], FR-2.7: Progress Tracking [P0] (+2 more)

### Community 284 - "Community 284"
Cohesion: 0.20
Nodes (10): 2.1 Color Palette, 2.2 Typography, 2.3 Spacing System, 2.4 Border Radius, 2.5 Shadows, 2. Design System, Font Families, Neutral Colors (+2 more)

### Community 285 - "Community 285"
Cohesion: 0.20
Nodes (10): 1.1 비즈니스 모델 캔버스, 고객 관계 (Customer Relationships), 고객 세그먼트 (Customer Segments), 비용 구조 (Cost Structure), 수익원 (Revenue Streams), 채널 (Channels), 핵심 가치 제안 (Value Propositions), 핵심 자원 (Key Resources) (+2 more)

### Community 286 - "Community 286"
Cohesion: 0.20
Nodes (10): 1. 대학 특화, 2. 올인원 플랫폼, 3. 단계별 성장 경로, 4. 창업 생태계, 6.1 차별화 요소, 6.2 진입 장벽, 6. 경쟁 우위, 기술적 장벽 (+2 more)

### Community 287 - "Community 287"
Cohesion: 0.20
Nodes (10): 7.1 수평적 확장, 7.2 수직적 확장, 7.3 제품 확장, 7. 확장 전략, 상위 가치사슬, 새로운 제품, 세그먼트 확장, 지역 확장 (+2 more)

### Community 288 - "Community 288"
Cohesion: 0.20
Nodes (10): 9.1 재정적 리스크, 9.2 시장 리스크, 9.3 운영 리스크, 9. 리스크 관리, 경쟁 심화, 비용 초과, 사용자 이탈, 수익 부진 (+2 more)

### Community 289 - "Community 289"
Cohesion: 0.20
Nodes (10): 6.2 경쟁 전략 프레임워크, 6.3 경쟁사별 대응 전략, 6. 경쟁 전략, Blue Ocean Strategy, vs 부트캠프, vs 엘리스, vs 인프런, vs 프로그래머스 (+2 more)

### Community 290 - "Community 290"
Cohesion: 0.20
Nodes (10): 기본 정보, 기술 프로필, 니즈 및 기대, 목표 및 동기, 성격 및 가치관, 성공 시나리오, 우리의 솔루션, 인구통계학적 정보 (+2 more)

### Community 291 - "Community 291"
Cohesion: 0.20
Nodes (9): 1.1 목적, 1.2 범위, 1.3 독자, 1. 문서 개요, 2.1 기능 카테고리, 2.2 우선순위 정의, 2. 기능 분류 체계, 3. 기능 요구사항 상세 (+1 more)

### Community 292 - "Community 292"
Cohesion: 0.20
Nodes (10): FR-5.1.1 질문 작성 [P0], FR-5.1.2 답변 작성 [P0], FR-5.1.3 투표 및 검색 [P0], FR-5.1 질의응답 (Q&A), FR-5.2.1 그룹 생성 [P1], FR-5.2.2 그룹 활동 [P1], FR-5.2 스터디 그룹, FR-5.3.1 프로젝트 쇼케이스 [P1] (+2 more)

### Community 293 - "Community 293"
Cohesion: 0.20
Nodes (10): FR-7.1.1 아이디어 제출 [P2], FR-7.1.2 아이디어 투표 [P2], FR-7.1 아이디어 등록, FR-7.2.1 팀원 모집 [P2], FR-7.2.2 지원 및 매칭 [P2], FR-7.2 팀 빌딩, FR-7.3.1 데모데이 신청 [P2], FR-7.3.2 투자자 매칭 [P3] (+2 more)

### Community 294 - "Community 294"
Cohesion: 0.20
Nodes (10): FR-8.1.1 학생 목록 [P0], FR-8.1.2 진도 모니터링 [P1], FR-8.1 학생 관리, FR-8.2.1 코스 생성/편집 [P1], FR-8.2.2 과제 채점 [P1], FR-8.2 콘텐츠 관리, FR-8.3.1 강의 통계 [P1], FR-8.3.2 학습 인사이트 [P2] (+2 more)

### Community 295 - "Community 295"
Cohesion: 0.20
Nodes (10): 4.1 클라우드 제공자: AWS, 4.2 배포 아키텍처, 4.3 CI/CD 파이프라인, 4. 인프라 아키텍처, GitHub Actions, 네트워킹, 데이터베이스, 보안 (+2 more)

### Community 296 - "Community 296"
Cohesion: 0.20
Nodes (10): "100명의 얼리어답터", 5.1 Pre-Launch 캠페인 (3월), 5.2 Launch 캠페인 (4월), 5.3 Growth 캠페인 (5-12월), 5.4 Re-engagement 캠페인 (지속), 5. 마케팅 캠페인, 이탈 사용자 복귀, "창업 아이디어 경진대회" (+2 more)

### Community 297 - "Community 297"
Cohesion: 0.20
Nodes (10): 10.1 마케팅 KPI, 10.2 대시보드, 10. KPI 및 측정, Acquisition (획득), Activation (활성화), Google Analytics, Referral (추천), Retention (리텐션) (+2 more)
...
Cohesion: 0.29
Nodes (5): AssignmentData, chapterContents, prisma, QuizData, QuizQuestionData

### Community 400 - "Community 400"
Cohesion: 0.29
Nodes (7): API (Application Programming Interface), Dependency, Environment (Dev/Staging/Production), Framework, General Development Concepts, Library, Repository (Repo)

### Community 401 - "Community 401"
Cohesion: 0.52
Nodes (6): check_docker(), main(), run_tests(), setup_database(), teardown_database(), run-tests.sh script

### Community 402 - "Community 402"
Cohesion: 0.29
Nodes (6): AdminUsersPage(), rankColors, rankLabels, roleColors, roleLabels, User
...
Cohesion: 0.33
Nodes (6): Phase 7.1: 단위 테스트, Phase 7.2: 통합 테스트, Phase 7.3: E2E 테스트, Phase 7.4: 성능 최적화, Phase 7.5: 보안 검토, Phase 7: 테스트 및 품질 관리 (Week 4-5)

### Community 410 - "Community 410"
Cohesion: 0.33
Nodes (6): Week 1 목표, Week 2 목표, Week 3 목표, Week 4 목표, Week 5 목표, 📊 성공 지표

### Community 411 - "Community 411"
Cohesion: 0.33
Nodes (6): 1. GitHub OAuth 미설정, 2. 프로필 페이지 미완성, 3. 댓글/투표 UI 미완성, 4. 테스트 커버리지 부족, 5. 배포 설정 미완성, ⚠️ 주의사항 및 미완성 부분

### Community 412 - "Community 412"
Cohesion: 0.33
Nodes (6): 10. Server-Side Request Forgery (SSRF), 보안 조치, 위험도: ✅ LOW, 조치 필요: URL 검증 유틸리티 추가 (추후), 현재 상태, 현재 외부 요청

### Community 413 - "Community 413"
Cohesion: 0.33
Nodes (6): 2. Cryptographic Failures (암호화 실패), 개선 사항, 구현 상태, 위험도: ⚠️ MEDIUM, 조치 필요: JWT 시크릿 강도 검증, HTTPS 강제, 현재 상태

### Community 414 - "Community 414"
Cohesion: 0.33
Nodes (6): 3. Injection (인젝션 공격), 구현 상태, 위험도: ✅ LOW, 조치 필요: DTO 검증 강화, 추가 보안, 현재 상태

### Community 415 - "Community 415"
Cohesion: 0.33
Nodes (6): 6. Vulnerable and Outdated Components (취약한 구성 요소), 발견된 취약점 (2026-01-23), 위험도: 🔴 CRITICAL, 조치 계획, 조치 필요: 즉시 의존성 업데이트, 현재 상태

### Community 416 - "Community 416"
Cohesion: 0.33
Nodes (6): 7. Identification and Authentication Failures (인증 실패), 개선 사항, 구현 상태, 위험도: ⚠️ MEDIUM, 조치 필요: 리프레시 토큰, Rate Limiting, 현재 상태

### Community 417 - "Community 417"
Cohesion: 0.33
Nodes (6): 1. 패키지 설치, 2. 서버 실행, 3. Swagger UI 확인, 4. OpenAPI 스펙 생성, 5. 테스트, 다음 단계

### Community 418 - "Community 418"
Cohesion: 0.33
Nodes (6): Step 1: 팀 관리 페이지 이동, Step 2: 크루원 검색, Step 3: 역할 선택, Step 4: 초대 보내기, Step 5: 초대 수락 대기, 팀원 추가 절차

### Community 419 - "Community 419"
Cohesion: 0.33
Nodes (6): 개인 프로젝트, 팀 프로젝트, 프로젝트 예시, 프로젝트 유형, 프로젝트란?, 프로젝트의 의미

### Community 420 - "Community 420"
Cohesion: 0.33
Nodes (6): 1. 내 프로필 위젯, 2. 내 프로젝트 목록, 3. 코스 진행 상황, 4. 활동 피드, 5. 레벨 진행률 차트, 대시보드 구성 요소

### Community 421 - "Community 421"
Cohesion: 0.33
Nodes (6): expectTextVisible, navigateTo, scrollToElement, typeWithDelay, waitForPageLoad, 유용한 헬퍼 함수

### Community 422 - "Community 422"
Cohesion: 0.33
Nodes (6): 10.1 User Growth Model, 10.2 Revenue Growth Model, 10.3 Market Share Projection, 10. Market Growth Projections, Assumptions:, Model:

### Community 423 - "Community 423"
Cohesion: 0.33
Nodes (6): 5.1 Positioning Statement, 5.2 Differentiation Strategy, 5.3 Competitive Advantages (Moats), 5. Competitive Positioning Strategy, Sustainable Competitive Advantages, Unique Value Propositions

### Community 424 - "Community 424"
Cohesion: 0.33
Nodes (6): 6.1 Demographics, 6.2 Goals, 6.3 Pain Points, 6.4 How WKU Software Crew Helps, 6.5 Quote, 6. Secondary Persona 1: Professor Kim - The Supportive Educator

### Community 425 - "Community 425"
Cohesion: 0.33
Nodes (6): 7.1 Demographics, 7.2 Goals, 7.3 Pain Points, 7.4 How WKU Software Crew Helps, 7.5 Quote, 7. Secondary Persona 2: Minseo - The Industry Mentor

### Community 426 - "Community 426"
Cohesion: 0.33
Nodes (6): 3. FR-1: Authentication & User Management, FR-1.1: User Registration [P0], FR-1.2: User Login [P0], FR-1.3: Social Authentication [P1], FR-1.4: Password Reset [P0], FR-1.5: User Profile Management [P0]

### Community 427 - "Community 427"
Cohesion: 0.33
Nodes (6): 6. FR-4: Deployment System, FR-4.1: One-Click Deployment [P0], FR-4.2: Custom Domains [P1], FR-4.3: Environment Variables [P1], FR-4.4: Deployment History [P1], FR-4.5: Preview Deployments [P2]

### Community 428 - "Community 428"
Cohesion: 0.33
Nodes (6): 7. FR-5: Community & Social Features, FR-5.1: Q&A Forum [P0], FR-5.2: Study Groups [P1], FR-5.3: Project Showcase [P1], FR-5.4: User Profiles [P0], FR-5.5: Leaderboard [P2]

### Community 429 - "Community 429"
Cohesion: 0.47
Nodes (3): AuthFixtures, mockUsers, test

### Community 430 - "Community 430"
Cohesion: 0.33
Nodes (6): 12. 프로젝트 일정 (High-Level), Phase 1: 기획 및 설계 (1-2개월), Phase 2: MVP 개발 (3-4개월), Phase 3: 베타 테스트 (1개월), Phase 4: 정식 런칭 (1개월), Phase 5: 확장 및 고도화 (지속)

### Community 431 - "Community 431"
Cohesion: 0.33
Nodes (6): 5.1 학습 관리 시스템 (LMS), 5.2 협업 개발 환경, 5.3 프로젝트 관리, 5.4 커뮤니티 & 소셜, 5.5 창업 지원, 5. 핵심 기능 개요

### Community 432 - "Community 432"
Cohesion: 0.33
Nodes (5): 7.1 시장 리스크, 7.2 기술 리스크, 7.3 운영 리스크, 7. 위험 요인 및 대응, WKU 소프트웨어 Crew Project - 시장 분석

### Community 433 - "Community 433"
Cohesion: 0.33
Nodes (6): 1. 디지털 전환 가속화, 2.1 거시적 트렌드, 2. 개발자 수요 폭증, 3. 스타트업 생태계 성장, 4. AI 및 자동화, 5. 평생 학습 문화

### Community 434 - "Community 434"
Cohesion: 0.33
Nodes (6): 6.1 시장 성장 시나리오, 6.2 시장 점유율 목표, 6. 시장 예측, 기준 시나리오 (Base Case), 낙관적 시나리오 (Best Case), 비관적 시나리오 (Worst Case)

### Community 435 - "Community 435"
Cohesion: 0.33
Nodes (6): 8.1 시장 매력도 평가, 8.2 전략적 권고사항, 8. 결론 및 권고사항, 단기 (1년), 장기 (5년), 중기 (2-3년)

### Community 436 - "Community 436"
Cohesion: 0.33
Nodes (6): 1. 산업 내 경쟁 (Rivalry), 2. 신규 진입 위협 (New Entrants), 3. 대체재 위협 (Substitutes), 4. 구매자 교섭력 (Buyer Power), 5. 공급자 교섭력 (Supplier Power), 6.1 포터의 5 Forces 분석

### Community 437 - "Community 437"
Cohesion: 0.33
Nodes (6): FR-9.1.1 학습 리포트 [P1], FR-9.1.2 진단 테스트 [P2], FR-9.1 사용자 분석, FR-9.2.1 어드민 대시보드 [P1], FR-9.2 플랫폼 분석, FR-9. 분석 및 리포팅

### Community 438 - "Community 438"
Cohesion: 0.33
Nodes (6): 3.2 폴더 구조 (NestJS), 3.3 데이터베이스 스키마 (Prisma), 3.4.1 인증 서비스, 3.4.2 실시간 협업 서비스, 3.4 주요 서비스 구현, 3. 백엔드 아키텍처

### Community 439 - "Community 439"
Cohesion: 0.33
Nodes (6): 8.1 수평 확장 (Horizontal Scaling), 8.2 수직 확장 (Vertical Scaling), 8. 확장성 전략, API 서버, 데이터베이스, 인스턴스 타입 업그레이드

### Community 440 - "Community 440"
Cohesion: 0.33
Nodes (6): 6.1 Breakpoints, 6.2 반응형 패턴, 6. 반응형 디자인, Font Size, Sidebar Toggle, Stack → Grid

### Community 441 - "Community 441"
Cohesion: 0.33
Nodes (6): 7.1 컬러 매핑, 7.2 다크 모드 컴포넌트 스타일, 7.3 토글 구현, 7. 다크 모드, Card, Input

### Community 442 - "Community 442"
Cohesion: 0.33
Nodes (6): 8.1 AARRR Funnel, 8.2 전환율 최적화 (CRO), 8. 퍼널 최적화, Checkout (유료 전환), Landing Page, Signup Flow

### Community 443 - "Community 443"
Cohesion: 0.33
Nodes (6): 10.1 GDPR 준수 (EU), 10.2 CCPA 준수 (미국 캘리포니아), 10. 국제 확장 대비, 주요 요구사항, 주요 요구사항, 준비 사항

### Community 444 - "Community 444"
Cohesion: 0.33
Nodes (6): 12.1 법인세, 12.2 부가가치세, 12.3 원천세, 12. 세무 계획, 법인세율, 세액 감면

### Community 445 - "Community 445"
Cohesion: 0.33
Nodes (6): 1. 인증 시스템, 2. 레벨 시스템, 3. 프로젝트 관리, 4. 온라인 코스, 5. 커뮤니티 Q&A, 🎯 주요 기능

### Community 446 - "Community 446"
Cohesion: 0.33
Nodes (6): Learning Path, Week 1-2: Web Basics, Week 3-4: Version Control, Week 5-6: Modern Frontend, Week 7-8: Backend & APIs, Week 9-10: Deployment & Tools

### Community 447 - "Community 447"
Cohesion: 0.33
Nodes (5): ApiResponse, CourseLevel, ProjectRole, UserRank, Visibility
...
Cohesion: 0.40
Nodes (5): AddMemberDto, CreateProjectDto, ProjectQueryDto, UpdateProjectDto, 데이터 검증

### Community 450 - "Community 450"
Cohesion: 0.40
Nodes (5): 2.6 배포 아키텍처 (Docker + Cloudflare), CI/CD 파이프라인, Cloudflare Tunnel 설정, Docker Compose 구조, 환경 분리

### Community 451 - "Community 451"
Cohesion: 0.40
Nodes (5): Could Have (있으면 좋음), MoSCoW 우선순위, Must Have (필수), Should Have (중요), Won't Have (제외)

### Community 452 - "Community 452"
Cohesion: 0.40
Nodes (3): prisma, QueryLog, queryLogs

### Community 454 - "Community 454"
Cohesion: 0.40
Nodes (5): Application Security, Database Security, Pre-Deployment, Security Checklist, Server Security

### Community 455 - "Community 455"
Cohesion: 0.40
Nodes (5): Phase 3.1: 프로젝트 목록 페이지, Phase 3.2: 프로젝트 생성/수정, Phase 3.3: 프로젝트 상세 페이지, Phase 3.4: 프로젝트 API 완성, Phase 3: 프로젝트 관리 시스템 (Week 2-3)

### Community 456 - "Community 456"
Cohesion: 0.40
Nodes (5): Phase 8.1: API 문서, Phase 8.2: 사용자 가이드, Phase 8.3: 배포 설정, Phase 8.4: 베타 테스트, Phase 8: 문서화 및 배포 (Week 5)

### Community 457 - "Community 457"
Cohesion: 0.40
Nodes (5): 🔄 Ralph Loop 활용 전략, 반복 작업 1: RESTful API 생성, 반복 작업 2: React 컴포넌트 생성, 반복 작업 3: 테스트 케이스 작성, 반복 작업 4: 타입 정의

### Community 458 - "Community 458"
Cohesion: 0.40
Nodes (5): 기능, 문서, 🎯 베타 런칭 체크리스트, 인프라, 품질

### Community 459 - "Community 459"
Cohesion: 0.40
Nodes (5): 1. Broken Access Control (취약한 접근 제어), 구현 계획, 위험도: ⚠️ HIGH, 조치 필요: JWT Guard, Roles Guard, Ownership Guard 구현, 현재 상태

### Community 460 - "Community 460"
Cohesion: 0.40
Nodes (5): 4. Insecure Design (안전하지 않은 설계), 아키텍처 보안, 위험도: ✅ LOW, 조치 필요: Threat Modeling 문서 작성 (추후), 현재 상태

### Community 461 - "Community 461"
Cohesion: 0.40
Nodes (5): 5. Security Misconfiguration (보안 구성 오류), 위험도: ⚠️ HIGH, 조치 필요: Helmet 설치 및 설정, CORS 정책 강화, 필수 보안 헤더, 현재 상태

### Community 462 - "Community 462"
Cohesion: 0.40
Nodes (5): 8. Software and Data Integrity Failures (무결성 실패), 구현 계획, 위험도: ⚠️ MEDIUM, 조치 필요: CI/CD 보안 스캔 자동화, 현재 상태

### Community 463 - "Community 463"
Cohesion: 0.40
Nodes (5): 9. Security Logging and Monitoring Failures (로깅 및 모니터링 실패), 로깅 전략, 위험도: ⚠️ MEDIUM, 조치 필요: Winston Logger 보안 이벤트 추가, 현재 상태

### Community 464 - "Community 464"
Cohesion: 0.40
Nodes (5): 베타 런칭 전 필수 (P1), 위험도 분포, 종합 평가, 즉시 조치 필요 (P0), 향후 개선 (P2)

### Community 465 - "Community 465"
Cohesion: 0.40
Nodes (5): 1. 인터랙티브 테스트, 2. 자동 인증, 3. 스키마 참조, 4. 코드 생성 준비, 주요 기능

### Community 466 - "Community 466"
Cohesion: 0.40
Nodes (5): API Versioning, Rate Limiting 문서화, Response 스키마 클래스, Webhook 문서화, 추가 개선 사항 (선택)

### Community 467 - "Community 467"
Cohesion: 0.40
Nodes (5): 새로 생성된 파일, 수정된 설정 파일, 수정된 파일 (DTO - 16개), 수정된 파일 (컨트롤러 - 9개), 파일 변경 목록

### Community 468 - "Community 468"
Cohesion: 0.40
Nodes (5): Step 1: 수강 신청 버튼 클릭, Step 2: 신청 확인, Step 3: 학습 시작, 수강 신청 취소, 코스 수강 신청

### Community 469 - "Community 469"
Cohesion: 0.40
Nodes (5): 다음 코스 추천, 완강 뱃지, 완강 조건, 완강 축하, 코스 완강

### Community 470 - "Community 470"
Cohesion: 0.40
Nodes (5): PRIVATE (비공개), PUBLIC (공개), TEAM (팀 전용), 가시성 변경, 프로젝트 가시성 설정

### Community 471 - "Community 471"
Cohesion: 0.40
Nodes (5): 대시보드 둘러보기, 대시보드 활용 팁, 동기 부여, 매일 확인하기, 목표 설정하기

### Community 472 - "Community 472"
Cohesion: 0.40
Nodes (5): 1. 기본 테스트 구조, 2. 페이지 객체 모델 사용, 3. 인증된 사용자 테스트, 4. API 모킹, 테스트 작성 가이드

### Community 473 - "Community 473"
Cohesion: 0.40
Nodes (5): 1. 선택자 우선순위, 2. 대기 처리, 3. 독립적인 테스트, 4. 의미 있는 테스트 이름, 모범 사례

### Community 474 - "Community 474"
Cohesion: 0.40
Nodes (5): 로컬에서 CI 환경 재현, 브라우저 설치 문제, 타임아웃 에러, 테스트가 느린 경우, 트러블슈팅

### Community 475 - "Community 475"
Cohesion: 0.40
Nodes (5): 1.1 Project Name, 1.2 Vision, 1.3 Mission, 1.4 One-liner, 1. Executive Summary

### Community 476 - "Community 476"
Cohesion: 0.40
Nodes (5): 7.1 User Metrics, 7.2 Engagement Metrics, 7.3 Business Metrics, 7.4 Learning Outcomes, 7. Success Metrics (KPIs)

### Community 477 - "Community 477"
Cohesion: 0.40
Nodes (5): 8.1 In Scope (MVP - Phase 1), 8.2 Phase 2 Features, 8.3 Phase 3 Features, 8.4 Out of Scope (Future Roadmap), 8. Project Scope

### Community 478 - "Community 478"
Cohesion: 0.40
Nodes (5): 9.1 Phase 0: Pre-Launch (January 2026), 9.2 Phase 1: MVP Development (February-April 2026), 9.3 Phase 2: Growth (May-August 2026), 9.4 Phase 3: Scale (September-December 2026), 9. Timeline & Milestones

### Community 479 - "Community 479"
Cohesion: 0.40
Nodes (5): 14.1 Market Attractiveness: HIGH ✅, 14.2 Market Entry Timing: EXCELLENT ✅, 14.3 Strategic Recommendations, 14.4 Go/No-Go Decision: GO ✅, 14. Conclusion & Recommendations

### Community 480 - "Community 480"
Cohesion: 0.40
Nodes (5): Appendix C: Competitor Profiles, Elice, Goorm, Inflearn, Programmers

### Community 481 - "Community 481"
Cohesion: 0.40
Nodes (5): 10.1 Competitive Assessment: FAVORABLE ✅, 10.2 Key Takeaways, 10.3 Success Factors, 10.4 Go-to-Market Recommendations, 10. Conclusion

### Community 482 - "Community 482"
Cohesion: 0.40
Nodes (5): 7.1 Monitoring Strategy, 7.2 Key Metrics to Track, 7.3 Competitive Intelligence Team, 7. Competitive Intelligence Framework, Information Sources

### Community 483 - "Community 483"
Cohesion: 0.40
Nodes (5): 13.1 Unit Tests, 13.2 Integration Tests, 13.3 E2E Tests, 13.4 Performance Tests, 13. Testing Requirements

### Community 484 - "Community 484"
Cohesion: 0.40
Nodes (5): 9. FR-7: Startup Resources (Master Class), FR-7.1: Startup Program Application [P1], FR-7.2: Business Plan Templates [P2], FR-7.3: Demo Day [P2], FR-7.4: Investor Directory [P3]

### Community 485 - "Community 485"
Cohesion: 0.40
Nodes (5): 5.1 Color Contrast, 5.2 Keyboard Navigation, 5.3 Screen Reader Support, 5.4 Text Alternatives, 5. Accessibility (WCAG 2.1 AA)
...
Cohesion: 0.40
Nodes (5): 7.1 사용자 지표, 7.2 학습 지표, 7.3 협업 지표, 7.4 비즈니스 지표, 7. 성공 지표 (KPI)
...
Cohesion: 0.40
Nodes (5): 9. 마일스톤 체크리스트, M1: 프로젝트 킥오프 ✅, M2: MVP 개발 완료, M3: 베타 테스트, M4: 정식 런칭

### Community 491 - "Community 491"
Cohesion: 0.40
Nodes (5): 1.1 정량적 목표, 1.2 정성적 목표, 1. 마케팅 목표, 1년차 (2026), 3년차 (2028)

### Community 492 - "Community 492"
Cohesion: 0.40
Nodes (5): 12.1 피드백 수집, 12.2 개선 프로세스, 12. 지속적 개선, 사용자 피드백, 팀 피드백

### Community 493 - "Community 493"
Cohesion: 0.40
Nodes (5): 1.1 적용 법규, 1.2 준수 원칙, 1. 법률 준수 프레임워크, 국내 법규, 국제 법규 (해외 진출 대비)

### Community 494 - "Community 494"
Cohesion: 0.40
Nodes (5): 6.1 연령 제한, 6.2 청소년 유해 콘텐츠 차단, 6. 청소년 보호, 콘텐츠 등급, 필터링

### Community 495 - "Community 495"
Cohesion: 0.40
Nodes (5): 7.1 소비자 권리, 7. 전자상거래 소비자 보호, 계약 철회권, 소비자 분쟁 해결, 정보 제공

### Community 496 - "Community 496"
Cohesion: 0.40
Nodes (5): 8.1 정기 점검, 8.2 법규 변경 모니터링, 8. 준수 모니터링, 분기별 개인정보 감사, 연간 법률 감사
...
## Knowledge Gaps
- **5824 isolated node(s):** `manifest_version`, `name`, `version`, `pre_installed`, `manifest_version` (+5819 more)
...
- **Are the 2 inferred relationships involving `cn()` (e.g. with `ReportDetailPage()` and `AdminProjectsPage()`) actually correct?**
